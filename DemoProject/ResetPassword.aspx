   ...
   <title>CCBank - Reset Password</title>
    <style>
        ...
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        .input-wrap input { width:100%; padding:11px 40px 11px 14px; border:1.5px solid var(--input-border); border-radius:8px; font-size:14px; background:var(--input-bg); color:var(--text); }
        .input-wrap input:focus { border-color:#f0a070; outline:none; }

...
<head runat="server">
    ...
    <style>
        ...
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        .question-box { background:var(--result-bg); border-left:4px solid #f0a070; border-radius:8px; padding:14px; margin-bottom:16px; font-size:14px; color:var(--text); font-style:italic; }
        .row { margin-bottom:14px; }
        .label { display:block; font-weight:bold; color:var(--label); margin-bottom:5px; font-size:13px; }
        input[type="text"] { width:100%; padding:11px 14px; border:1.5px solid var(--input-border); border-radius:8px; font-size:14px; background:var(--input-bg); color:var(--text); }
        input[type="text"]:focus { border-color:#f0a070; outline:none; }

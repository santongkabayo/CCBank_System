...
<head runat="server">
    ...
    <style>
        ...
        * { box-sizing:border-box; margin:0; padding:0; transition:background 0.3s,color 0.3s; }
        ...
        /* Fixed: Using absolute transparency ensures client validators parse the field successfully */
...
<body>
    ...
    <div class="main">
        <div class="page-card">
            ...
            <div class="row">
                ...
                <div class="hint">Min: ₱100.00 | Max: ₱500,000.00 | Exact amounts accepted (e.g., ₱111)</div>
                ...
                <asp:RangeValidator ID="rngAmount" runat="server"
                    ControlToValidate="txtAmount" MinimumValue="100" MaximumValue="500000" Type="Double"
                    ErrorMessage="Amount must be between ₱100.00 and ₱500,000.00." ForeColor="Red" Display="Dynamic" CssClass="error" />
            </div>

            <div class="btn-row">
                <asp:Button ID="btnDeposit" runat="server" Text="💰 Deposit"
                    OnClick="btnDeposit_Click" CssClass="btn-primary" />
    ...
    <script>
        // Copy user entry into hidden validation frame input field
